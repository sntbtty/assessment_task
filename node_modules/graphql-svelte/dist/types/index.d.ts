 ...
 */
export declare type GraphQLCache = Record<GraphQLCacheKey, GraphQLCacheValue>;
/**
 ...
 */
export declare type GraphQLCacheKey = string;
/**
 * JSON serializable GraphQL operation result that includes errors and data.
 */
export declare type GraphQLCacheValue = {
    fetchError?: string;
    httpError?: HttpError;
    parseError?: string;
 ...
 */
export declare type GraphQLFetchOptions = {
    url: string;
    /**
