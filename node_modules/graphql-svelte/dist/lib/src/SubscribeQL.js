...
exports.SubscribeQL = exports.SubscriptionClient = void 0;
//@ts-ignore
var backo_1 = __importDefault(require("backo"));
var mitt_1 = __importDefault(require("mitt"));
var _a = mitt_1.default(), on = _a.on, off = _a.off, emit = _a.emit;
var symbol_observable_1 = __importDefault(require("symbol-observable"));
...
var SubscriptionClient = /** @class */ (function () {
    function SubscriptionClient(url, options) {
        ...
        this.backoff = new backo_1.default({ jitter: 0.5 });
        this.client = null;
    ...
    SubscriptionClient.prototype.request = function (request) {
        ...
        return _a = {},
            //@ts-ignore
            _a[symbol_observable_1.default["default"] ? symbol_observable_1.default["default"] : symbol_observable_1.default] = function () {
                return this;
            },
        ...
        switch (this.status) {
            case this.wsImpl.OPEN:
                ...
                try {
                    ...
                    this.eventEmitter("error", new Error("Message must be JSON-serializable. Got: " + message));
                }
            ...
            default:
                if (!this.reconnecting) {
                    this.eventEmitter("error", new Error("A message was not sent because socket is not connected, is closing or " +
    ...
    SubscriptionClient.prototype.tryReconnect = function () {
        ...
        if (!this.reconnecting) {
            Object.keys(this.operations).forEach(function (key) {
                _this.unsentMessagesQueue.push(_this.buildMessage(key, "start", _this.operations[key].options));
            });
    ...
    SubscriptionClient.prototype.connect = function () {
        ...
        this.client.addEventListener("open", function () { return __awaiter(_this, void 0, void 0, function () {
            var connectionParams, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.status === this.wsImpl.OPEN)) return [3 /*break*/, 4];
                        this.clearMaxConnectTimeout();
                        this.closedByUser = false;
                        this.eventEmitter(this.reconnecting ? "reconnecting" : "connecting");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.connectionParams()];
                    case 2:
                    ...
                    case 3:
                        error_1 = _a.sent();
                        this.sendMessage(undefined, "connection_error", error_1);
                        this.eventEmitter('error', error_1);
                        this.flushUnsentMessagesQueue();
                        return [3 /*break*/, 4];
        ...
        this.client.addEventListener("error", function (error) {
            ...
            _this.eventEmitter("connection_error", error);
        });
        this.client.addEventListener("message", function (_a) {
            var data = _a.data;
    ...
    SubscriptionClient.prototype.processReceivedData = function (receivedData) {
        ...
        if (["data", "complete", "error"].includes(parsedMessage.type) &&
...
//# sourceMappingURL=SubscribeQL.js.map